...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/css1/default.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/css1/account.css">
<link href="${pageContext.request.contextPath }/css/css1/left.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath }/css/css1/basic.css" rel="stylesheet" type="text/css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/css1/tab1.css">
<link href="${pageContext.request.contextPath }/css/css1/details.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath }/css/css1/detailslist.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath }/css/css1/borrowselect.css" rel="stylesheet" type="text/css">
<style type="text/css">
        .tdTitle
        {
            text-align: right;
...
<link href="${pageContext.request.contextPath }/css/css1/backpager.css" rel="stylesheet" type="text/css">
...
<dd><a href="${pageContext.request.contextPath }/account_loanReturnPlanList.jsp">回款计划</a></dd>
<dd><a href="${pageContext.request.contextPath }/AutoTenderList.jsp">自动投标</a></dd>
...
<form method="post" action="./account_borrowTypeSelect.aspx" id="form1" style="*margin-top:10px">
<div class="aspNetHidden">
<input name="__VIEWSTATE" id="__VIEWSTATE" value="J1sMDZZ6KOdjW17dsGWFKGwWq4KwNCDRrQ09vE3pf6UuIz673oP0KPTme/Tc1WHjsXLwQBVoo+g59QN+RMnoAp21wzon7glTx1mGXlrOsNg5+IumbMua+/2/60Q=" type="hidden">
</div>
<div class="aspNetHidden">
<input name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="76411590" type="hidden">
</div>
...
<dd id="" class="currentMenu"><a href="${pageContext.request.contextPath }/loadPersonShenHe">借入人审核</a></dd>
...
<div class="account-rightBox" style="">
<div class="box-padding">
<div class="nav_top">
<ul class="nav_title">
<li class="tab_title_a">
<a href="javascript:;">借款类型选择</a>
</li>
</ul>
</div>
<div class="content" style="text-align: left; height: auto; overflow: hidden; border: none;">
<div class="jksq_sl" style="margin: 10px;">
<ul>
<li>
<div class="jksq_sl_title jksq_sl_color_o">企业贷款</div>
<div class="jksq_sl_con">
企业贷款是指实体企业通过线上申请借款，团贷网的线下业务及风控团队进行实地考察及严格的信用审核之后，符合信用标准的借款企业在提供足额担保抵押物的前
提下， 团贷网通过引入第三方担保机构对其提供借款担保，完成一系列信用审核、资质验证、担保抵押等手续后，在团贷网上发布的企业借款标的。</div>
<div class="jksq_sl_btn">
<a href="javascript:void(0);" class="selecttype" attrtype="1" attrhref="${pageContext.request.contextPath }/person_account_consume_basic">
<img src="${pageContext.request.contextPath }/static/img1/jksq_sl_btn.gif" width="232" height="48"></a></div>
</li>
<li class="pl_15">
<div class="jksq_sl_title jksq_sl_color_b">
个人(车贷)</div>
<div class="jksq_sl_con">
以借款人的汽车作为授信的反担保物，团贷综合评估借款人工作收入情况及车辆状况后，对其授信一定额度发标借款。与项目借款相比，借款对象主要是个人，借款金额相对较小，投资门槛也较低，灵活性较高。</div>
<div class="jksq_sl_btn">
<a href="javascript:void(0);" class="selecttype" attrtype="4" attrhref="${pageContext.request.contextPath }/person_account_consume_basic">
<img src="${pageContext.request.contextPath }/static/img1/jksq_sl_btn_car.gif" width="232" height="48"></a></div>
</li>
<li class="pl_15">
<div class="jksq_sl_title jksq_sl_color_b">
个人(消费贷)</div>
<div class="jksq_sl_con">
个人贷款是团贷网根据市场需求，结合团贷网独特的渠道及平台优势，最新开发的借贷产品。个人贷款依然属于抵押担保贷款的范畴，其原理与企业贷款类似，但在
取信、验资、信审等流程上更加严格细致，需借款人提供全方位的个人资产及信用信息，同时引入第三方担保为借款人提供抵、质押担保，是一款安全灵活的个人借
款产品。</div>
<div class="jksq_sl_btn">
<a href="javascript:void(0);" class="selecttype" attrtype="5" attrhref="${pageContext.request.contextPath }/person_account_consume_basic">
<img src="${pageContext.request.contextPath }/static/img1/jksq_sl_btn3.gif" width="232" height="48"></a></div>
</li>
<li style="margin: 10px 0 0 0;">
<div class="jksq_sl_title jksq_sl_color_b">
个人(房贷)</div>
<div class="jksq_sl_con">
以借款人的房产作为授信的反担保物，团贷综合评估借款人工作收入情况及房产状况后，对其授信一定额度发标借款。与项目借款相比，借款对象主要是个人，借款金额相对较小，投资门槛也较低，灵活性较高。</div>
<div class="jksq_sl_btn">
<a href="javascript:void(0);" class="selecttype" attrtype="6" attrhref="${pageContext.request.contextPath }/person_account_consume_basic">
<img src="${pageContext.request.contextPath }/static/img1/jksq_sl_btn_house.gif" width="232" height="48"></a></div>
</li>
</ul>
</div>
</div>
...
<script type="text/javascript" language="javascript">
        $(function () {
            $(".selecttype").click(function () {
                ...
                var strhref = $(this).attr("attrhref");
                $.ajax({
                    url: "./loadPersons",
                    type: "post",
                    dataType: "json",
                    data: {
                        Cmd: "updateBorrowType",
                        type: type
                    },
...
<script type="text/javascript">
        $("#menu_borrowerApprove").addClass("currentMenu");
    </script>
<script type="text/javascript">
        (function () {
