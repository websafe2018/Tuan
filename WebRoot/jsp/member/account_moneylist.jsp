...
<script data-require-id="echarts/chart/pie" src="${pageContext.request.contextPath }/js/js1/pie.js" async=""></script></head>
<body>
<div class="header">
...
<a href="${pageContext.request.contextPath }/jsp/member/account_default.jsp"  class="reg">${myBody.b_nickname }</a><span>|</span><a href="javascript:logout();">退出</a><span>|</span></div>
...
<%-- myaccountScroll<dt><a href="${pageContext.request.contextPath }/jsp/member/account_default.jsp">
...
<form method="post" action="./account_moneylist.aspx" id="form1" style="*margin-top:10px">
<div class="aspNetHidden">
<input name="__VIEWSTATE" id="__VIEWSTATE" value="8c7C3gygfNT880mYW0wHWqRc/PUKsKADyZ8a0Ys+pcsf6OqHBk04zYhEGrhtVAyd7N8i+eWsIYX0f2eJPdjqKFO2NhsdSWZyom+j+UK2rWLzkTLGK0qtpmYH5z0=" type="hidden">
</div>
<div class="aspNetHidden">
<input name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="23745D2B" type="hidden">
</div>
...
<dd id="" class="currentMenu"><a href="${pageContext.request.contextPath }/jsp/member/account_moneylist.jsp">资金统计</a></dd>
...
<span class="font-14 fl_r" style="color: rgb(179, 177, 177);">总计=可用余额+待收本金+待收利息+投资待满标+提现待审核+活动奖金+冻结资金</span>
资产总计：<span class="font-orange font-bold">￥
<c:out value="${allMoney  }" default="0.00"></c:out>
</span>
</p>
</div>
<div class="circle-type chartbox" style="margin-bottom: 15px;">
<div class="circle " id="circle" style="width: 530px; height: 320px; padding-top: 5px; -moz-user-select: none; background-color: rgba(0, 0, 0, 0); cursor: default;" _echarts_instance_="1506131254698"><div style="position: relative; overflow: hidden; width: 530px; height: 320px;"><div style="position: absolute; left: 0px; top: 0px; width: 530px; height: 320px; -moz-user-select: none;" data-zr-dom-id="bg"></div><canvas style="position: absolute; left: 0px; top: 0px; width: 530px; height: 320px; -moz-user-select: none;" width="530" height="320" data-zr-dom-id="1"></canvas><canvas style="position: absolute; left: 0px; top: 0px; width: 530px; height: 320px; -moz-user-select: none;" width="530" height="320" data-zr-dom-id="_zrender_hover_"></canvas></div></div>
<div style="position: absolute; left: 148px; top: 50px; display: none;" id="defaultPic">
<img src="${pageContext.request.contextPath }/static/img1/cir0.png" alt="" style="width: 233px;"></div>
<div class="circle-data" style="top: 48px;">
<p style="height: 35px;">
<i style="background: #FF8247;"></i>可用金额：￥
<c:out value="${myBody.a_acBalance }"></c:out>
</p>
<p style="height: 35px;">
<i style="background: #87CEFF;"></i>待收本金：￥
<c:out value="${myMoney-backMoney }" default="0.00"></c:out>
</p>
<p style="height: 35px;">
<i style="background: #CD69C9;"></i>待收利息：￥
<c:out value="${income-backIncome }" default="0.00"></c:out>
</p>
<p style="height: 35px;">
<i style="background: #43CD80;"></i>投资待满标：￥0.00
</p>
<p style="height: 35px;">
<i style="background: #5CACEE;"></i>提现待审核：￥0.00
</p>
<p style="height: 35px;">
<i style="background: #FF69B4;"></i>剩余活动奖金：￥0.00
</p>
<p style="height: 35px;">
<i style="background: #9F79EE;"></i>冻结资金：￥0.00
</p>
</div>
</div>
<iframe src="${pageContext.request.contextPath }/jsp/member/account_moneylist_include.jsp" style="height: 463px" name="ymziframe" border="0" vspace="0" hspace="0" marginwidth="0" marginheight="0" framespacing="0" scrolling="no" width="100%" frameborder="0"></iframe>
...
<li style="width: 260px;">累计投资金额：<span class="font-orange d2">￥
<c:out value="${myMoney }" default="0.00"></c:out>
</span></li>
<li style="width: 260px;">累计充值金额 ：<span class="font-orange d2">￥
<c:out value="${allRecharge  }" default="0.00"></c:out>
</span></li>
<li style="width: 260px;">累计借入金额 ：<span class="font-orange d2">￥
<c:out value="${allLoadMoney  }" default="0.00"></c:out>  
</span></li>
<li style="width: 260px;">累计提现金额 ：<span class="font-orange d2">￥0.00</span></li>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/js1/moneylist.js"></script>
<script type="text/javascript">
