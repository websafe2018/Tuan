 ...
 //已完成的借款--------------------------------------------------------------------------------------------      
	...
	$.post("/Tuan/findjilu.do",{"uid":uid},function(data){
		...
		if(data[i].loadStatus==2){
			...
			if(data[i].loadStatus==2){
			var loadStatus=$("<td class=\"txt_center \" ></td>").text("审批未通过");
			...
			var div="<div class='list-item-1' style='width: 82px; z-index: 0;'><dl><dt><a href='#'>不可操作</a></dt></dl></div>";
