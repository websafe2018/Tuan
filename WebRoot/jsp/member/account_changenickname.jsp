...
<script
	src="${pageContext.request.contextPath }/js/homepage/account_changenickname.js"></script>
<script type="text/javascript" async=""
	src="${pageContext.request.contextPath }/css/js1/webaccess.js"></script>
<script
	src="%E5%9B%A2%E8%B4%B7%E7%BD%91%20-%20%E7%BB%BC%E5%90%88%E9%87%91%E8%9E%8D%E6%9C%8D%E5%8A%A1%E5%B9%B3%E5%8F%B0,%E8%AE%A9%E9%87%91%E8%9E%8D%E6%9B%B4%E7%AE%80%E5%8D%95%EF%BC%81%E5%9F%BA%E6%9C%AC%E4%BF%A1%E6%81%AF_files/hm.txt"></script>
<script type="text/javascript">
	var _hmt = _hmt || [];
	(function() {
					...
					<span class="rel member-list z1"> <i
						...
						<ul class="abs z1  ">
							<li><a rel="nofollow" href="#" target="_blank"
								style="display: block" class="member-link"><i class="icon a"></i>会员中心</a>
							</li>
							<li class="mission " style="display: none"><a rel="nofollow"
								href="#" target="_blank">团币任务</a></li>
						</ul>
					</span>
					<!-- <span>|</span> -->
			...
			<div class="nav-box auto w1200 fix">
				...
				<div class="nav r">
					<ul>
						...
						<li class="nav-t "><a
							href="${pageContext.request.contextPath }/lntellgent">网贷</a></li>



						<li class="nav-t"><a rel="nofollow" href="#">新手</a></li>
						<li class="nav-t "><a href="#">会员交易</a></li>
						<li class="nav-t ">
						...
						<li class="nav-t"><a
							href="${pageContext.request.contextPath }/loadMoney">借款</a></li>
				...
				<div class="account-left">
					...
					<div>
						<dl>
							...
							<dd id="">
								<a
									href="${pageContext.request.contextPath }/Validat_eindex.html">安全中心</a>
							</dd>
							<dd id="">
								<div class="left-new"></div>
								<a
							...
							<dd id="">
								<a
									href="${pageContext.request.contextPath }/account_notice.html">消息中心</a>
							</dd>
						</dl>
					...
					<div class="information">
						<div class="name">
							<p class="font-14 font-333 fw">
								<span id="text1"></span><span class="yonghuming font-orange2">${myBody.b_nickname }</span><span
									id="text2"></span>
							</p>
						</div>
				...
				<div class="box-padding margin-top-10 clearfloat Picture_upload">
					<div class="nav_top">
						<ul class="nav_title">
							...
							<li class="tab_title_b"><a
								href="${pageContext.request.contextPath }/jsp/member/account_useravatar.jsp">头像设置</a>
							</li>
							<li class="tab_title_a"><a href="javascript:;">修改昵称</a></li>
						</ul>
					</div>
					<div
						class="account_notice margin-top-20 clearfloat margin-bottom-20">
					...
					<div class="content margin-top-10"
						style="height: auto; min-height: 550px; overflow: hidden; background: #fff !important;">
						<div
							style="width: 100%; height: auto; margin-bottom: 20px; margin-top: 15px; overflow: hidden">
							<table
								style="width: 726px; float: left; padding: 0px; border-collapse: collapse; text-align: left;"
								id="formTb" cellspacing="0" cellpadding="0">



								<tbody>
									<tr>
										<input id="uid" type="text" value="${users.id }"
											hidden="hidden" />
										<td class="tdTitle">用户名：</td>
										<td class="tdContent"><span id="name">${users.userName }</span>
										</td>
									</tr>
									<tr>
										<td class="tdTitle">昵称：</td>
										<td class="tdContent"><input id="txtNickName"
											name="txtNickName" class="input-text2"
											style="height: 18px !important;" value="${myBody.b_nickname }"
											type="text"> <input style="display: none"></td>
									</tr>
								</tbody>
							</table>
						</div>
						<div style="text-align: center; width: 740px; height: 30px; margin: 10px;">
							<input onclick="upnickname()" value="提交更新"
								class="submit-btn font-16" style="height: 40px; width: 100px;" type="button" />
								 <input onclick="location.href=location.href;" value="取消" class="submit-btn font-16"
								style="background: #999; margin-left: 20px; height: 40px;"
								type="button" />
						</div>
					</div>
				</div>
