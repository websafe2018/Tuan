...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/homepage/account_loaninbid.js"></script>
...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/css1/account-public_002.css">
...
.nav_title li{float:left; margin:0px;   font-size:16px; width: 120px; }
...
.tab2_title_a {width:130px; height:44px; line-height:44px; border-bottom:#ffa200 solid 4px; text-align:center; cursor:pointer;}
.tab2_title_b {width:130px; height:44px; line-height:44px; border-bottom:#fff solid 4px; text-align:center; cursor:pointer;}
...
<script data-require-id="echarts/chart/pie" src="${pageContext.request.contextPath }/js/js1/pie.js" async=""></script>
</head>
<body>
<div class="header">
...
<form method="post" action="./account_loaninbid.aspx" id="form1" style="*margin-top:10px">
<div class="aspNetHidden">
<input name="__VIEWSTATE" id="__VIEWSTATE" value="nYMK6KNLj3vZcdLc4MJusNDAZ3eNK+R8JiN5ghyc6Uxr6KhWKqVWRJ0jZbpBRavsj1MFav6cMldHCFO/bwYjuYP9S9C7RB6gVmzJPWMermvnLCf3d/BRzsLSgkJoMy+DHRk56LYgWcy/IJnOFIb4MdGWDsVeIRk8gveKPubysmx/dXPvzaLbrbx4t4H6rMZQ0wdRtqWCnhBxDxhUuLMXoS8XINn2mSmMxr3DzsmkwaYzPwV/sI7WtnO7aIA=" type="hidden">
</div>
<div class="aspNetHidden">
<input name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="B289F617" type="hidden">
</div>
...
<dd id="" class="currentMenu"><a href="${pageContext.request.contextPath }/jsp/member/account_loaninbid.jsp">散标投资</a></dd>
...
<dd id=""><a href="${pageContext.request.contextPath }/jsp/member/account_touplevel.jsp">团贷会员</a></dd>
...
累计收益： <span class="font-22 font-orange2">￥
<c:out value="${income}" default="0.00"></c:out>
</span>
</div>
<div class="t1 font-666 font-14  fl_l">累计投资： <span class="font-22 font-orange2">￥
<c:out value="${myMoney }" default="0.00"></c:out>
</span></div>
</div>
<div id="account_infoLeft" style="width: 800px; height: 142px; -moz-user-select: none; background-color: rgba(0, 0, 0, 0); cursor: default;" _echarts_instance_="1506132514086"><div style="position: relative; overflow: hidden; width: 800px; height: 142px;"><div style="position: absolute; left: 0px; top: 0px; width: 800px; height: 142px; -moz-user-select: none;" data-zr-dom-id="bg"></div><canvas style="position: absolute; left: 0px; top: 0px; width: 800px; height: 142px; -moz-user-select: none;" width="800" height="142" data-zr-dom-id="1"></canvas><canvas style="position: absolute; left: 0px; top: 0px; width: 800px; height: 142px; -moz-user-select: none;" width="800" height="142" data-zr-dom-id="_zrender_hover_"></canvas></div></div>
<div class="account_infobox">
<div class="account_infoLeft-data">
<p class="font-14 margin-top-15"><i class="i1"></i>待计息投资：<span class="font-666">￥0.00</span> </p>
<p class="font-14 margin-top-5"><i class="i2"></i>回款中资金：<span class="font-666">￥0.00</span></p>
<p class="font-14 margin-top-5"><i class="i3"></i>已完成投资：<span class="font-666">￥
<c:out value="${myMoney }" default="0.00"></c:out>
</span></p>
</div>
<div class="account_infoLeft-data " style="left: 600px;">
<p class="font-14 margin-top-15"><i class="i1"></i>待收利息：<span class="font-666">￥
<c:out value="${income -backIncome  }" default="0.00"></c:out>
</span> </p>
<p class="font-14 margin-top-5"><i class="i2"></i>已赚利息：<span class="font-666">￥
...
<div class="c1" style=" position: absolute; top:91px; left:25px; z-index: 1;">
<img src="${pageContext.request.contextPath }/static/img1/cir0.png"></div><div class="c1" style=" position: absolute; top:91px; right:263px; z-index: 1;"><img src="${pageContext.request.contextPath }/static/img1/cir0.png"></div></div>
<div class="box-padding margin-top-10">
<div class="account_tableBox clearfloat">
<div class="nav_top">
<ul class="nav_title">
<li class="tab_title_a">
<a href="javascript:viod(0);">进行中的投资</a>
</li>
<li class="tab_title_b" onclick="javascript:window.location.href='/member/account_loanincomplete.aspx';">
<a href="https://www.tuandai.com/member/account_loanincomplete.aspx">已完成的投资</a>
</li>
<li class="tab_title_b" onclick="javascript:window.location.href='/member/account_assignmentclaims.aspx';">
<a href="https://www.tuandai.com/member/account_assignmentclaims.aspx">债权转让列表</a>
</li>
<li class="tab_title_b" onclick="javascript:window.location.href='/member/account_bondsundertake.aspx';">
<a href="https://www.tuandai.com/member/account_bondsundertake.aspx">债权承接列表</a>
</li>
</ul>
<div class="account_navyRight" style="height: 44px; line-height: 44px;">
<a href="${pageContext.request.contextPath }/jsp/member/account_loanReturnPlanList.jsp">查看回款计划</a>
</div>
</div>
<dl class="account_screen margin-top-20">
<dt>筛选：</dt>
<dd>
<a class="screen_now" href="${pageContext.request.contextPath }/jsp/member/account_loaninbid.jsp?status=All">全部(<span id="all"></span>)</a>
<a href="${pageContext.request.contextPath }/jsp/member/account_loaninbid.jsp?status=Recycling">正常回款(<span id="ok"></span>)</a>
<a href="${pageContext.request.contextPath }/jsp/member/account_loaninbid.jsp?status=Overdue">逾期(0)</a>
<a href="${pageContext.request.contextPath }/jsp/member/account_loaninbid.jsp?status=Investing">投标中(0)</a>
<a href="${pageContext.request.contextPath }/jsp/member/account_loaninbid.jsp?status=Flow">流标(0)</a>
</dd>
</dl>
...
<th class="a_low02 pl10" align="left">投资日期
</th>
<th class="a_low12" align="left">投资标号
</th>
<th class="a_low02" align="left">类型
</th>
<th class="" align="left">投资金额
</th>
<th class="a_low05" align="left">利率
</th>
<th class="a_low05">投标<br>
数量
</th>
<th class="a_low04">回款方式
</th>
<th class="a_low06" align="center">回款<br>
期数
</th>
<th class="a_low07">状态
</th>
<th class="a_low06" align="center">操作
</th>
</tr>

</tbody></table>
<div id="pager" style="text-align: center;" class="yahoo2">
</div>
</div>
</div>
</div>
...
<script type="text/javascr" src="${pageContext.request.contextPath }/js/js1/jquery-1.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath }/js/js1/contract.js"></script>
<script type="text/javascript">
                $("#menu_mySubscribe").addClass("currentMenu");
    </script>
<script type="text/javascript">
        function CheckReason(projectId, typeid) {
            if (typeid == "16") {
                $.ajax({
                    async: false,
                    type: "get",
                    url: '/member/account_loaninbid.aspx?method=reason&Id=' + projectId,
                    success: function (data) {
                        $("#dvReasonContent").html(data);
                    },
                    cache: false
                });
            }
            else if (typeid == "17") {
                $("#dvReasonContent").html("<div><div style='font-size:16px;'>投标期限已到，未满标，导致流标。</div><div style='margin:5px 0px 0px 0px;font-size:16px;'>您出借的资金已自动返回您的账户</div></div>");
            }

            //var reasonDialog = art.dialog({
            //    id: 'reasonDialog' + Math.random(),
            //    title: "流标原因",
            //    content: document.getElementById("dv_FlowReason"),
            //    width: 400,
            //    zIndex: 9999999,
            //    okVal: '查看我的资金',
            //    ok: function () {
            //        window.location.href = "/member/account_moneyhistory.aspx";
            //    }
            //});
            showDialWindows("流标原因", content, "查看我的资金", function () {
            closeLoadingWindows();
             window.location.href = "/member/account_moneyhistory.aspx";
            })
        }
        ...
        $(function () {
            ...
            $(document.body).append("<span id=\"tips\" style=\"display:none;padding:2px 5px;position: absolute; top:0px; left: 0px; border: 1px solid #E9D315;color: #5B5316; background-color: #F9F2BA;\">温馨提示：合同查看密码为你的手机号码。</span>");
            //下载合同鼠标事件
            $("a.download").mouseover(function () {
                var left = getLeft(this);
                var top = getTop(this);
                $("#tips").css("left", left - 240);
                $("#tips").css("top", top - 4);
                $("#tips").show();
            });

            //下载合同鼠标事件
            $("a.download").mouseout(function () {
                $("#tips").hide();
            });
            ...
            $(".account_tableNR .list-item-1 dl").mouseover(function () {
        ...
        function showInfo(id) {
            $.ajax({
                async: false,
                url: '/member/account_SubscribeDetail.aspx?id=' + id,
                success: function (data) {
                    htmlContent = data;
                },
                cache: false
            ...
            //    padding: 10
            //});
            showDialWindows("详情", htmlContent);
            $("#dial-window table:eq(0) td[align!=right]").css({ "text-align": "left" });
            $("#dial-window").css({ "width": "600px", "margin-left": "-300px" });
            $("#dial-window .body").css({ "width": "540px" });
            //console.log($("#dial-window form table:eq(1) tr").length);
            if ($("#dial-window form table:eq(1) tr").length > 9) {
                $("#dial-window form").css({ "overflow-y": "scroll", "height": "280px" });
            }
        }
    </script>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/js1/InintInvestRecordHeader.js"></script>
<script type="text/javascript">
        (function () {
...
<span id="tips" style="display:none;padding:2px 5px;position: absolute; top:0px; left: 0px; border: 1px solid #E9D315;color: #5B5316; background-color: #F9F2BA;">温馨提示：合同查看密码为你的手机号码。</span>
