...
%>
<!DOCTYPE html>
<!-- saved from url=(0050)http://info.tuandai.com/about/platform.jsp?mark=1 -->
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>
    ...
    <div class="nav-w suspension   fixed z5 t0 l0 suspension" style="width:100%">
        <div class="nav-box auto w1200  fix">
            <div class="r rel tc  slid z3">
                <dl id="myaccount" class="abs i-b-d vt about-us r0"><dt><a href="${pageContext.request.contextPath }/jsp/member/account_default.jsp"><i class="account-icon i-b-d icon vm"></i>我的账户</a></dt></dl>
            </div>
            <div class="nav r">
                <ul>
                    <li class="nav-t">
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/css3/da_ka.css">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/css3/platform.css">

<div class="containder w1200 auto cl fix">

    <div class="position">您当前所在的位置：<a href="${pageContext.request.contextPath }/investmenthome.jsp">团贷网</a> &gt; <a href="${pageContext.request.contextPath }/platform">关于我们</a> &gt;  平台简介</div>

<div class="l left-side w218" id="left-side">
  <dl show="0" >
        <dt>关于我们<i class="shareholder-icon left-arrow-up"></i></dt>
        <dd style="display: block;"><a class="" href="${pageContext.request.contextPath }/jsp/information/platform.jsp" target="_blank" class="left-selected">平台简介</a></dd>
    ...
    <div class="r right-side w996">
        <div class="modular">
            <div><img src="${pageContext.request.contextPath }/static/img3/banner1.jpg"></div>
            <div class="intr">
                <div class="f22 g3 pb20">关于平台</div>
                <p>　　团贷网丨网贷投资平台（tuandai.com，以下简称“团贷网网贷投资平台”）成立于2011年，并于2012年正式上线运营，是一家专注于帮扶小微企业的网络借贷信息中介服务平台。目前，团贷网网贷投资平台的运营主体为东莞团贷网互联网科技服务有限公司，致力于向借款人和出借人提供信息搜集、信息公布、信息交互、借贷撮合等优质服务。东莞团贷网互联网科技服务有限公司注册资本达10293.3334万元，以先进的信息技术水平、专业的大数据分析能力、严格的审核程序和完善的风险管控系统为基础，为有投融资需求的个人、机构或企业搭建一个安全合规、高效便捷的信息中介服务平台。
</p>
<p>　　经过多年的耕耘和发展，团贷网先后入选成为中国互联网金融协会首批会员单位、广东省“互联网+金融”试点项目等，获得国家高新技术企业、广东省电子商务创新示范企业、东莞市成长型企业、年度普惠金融卓越品牌等荣誉。</p>
<p>　　2017年3月，团贷网网贷投资平台联手厦门银行打造的银行存管系统正式上线。此前团贷网母公司派生集团已完成三轮6.75亿元的融资，截至2017年5月，派生集团又获得新一轮融资，共计人民币18亿元。本轮融资由民生资本投资管理有限公司领投，北京盈生创新科技有限责任公司、黄山海慧科技投资有限公司及北海宏泰投资有限公司等企业跟投完成。该轮融资将主要用于加大科技创新领域的投入、集团相关金融牌照的布局，也为集团相关板块未来进入资本市场筹备所需资金，并将增加实业科技板块的投资和布局。未来，团贷网将形成“科技+产业+金融”的生态圈，以拓展更大的战略生存空间。</p>            </div>
        </div>
        <div class="modular">
            <h2>办公环境<i class="shareholder-icon h2-arrow"></i></h2>
            <div class="list-box " style="position: relative;">
                <div class="pic-list rel  grou-1">
                                                                    <img class="img-1" src="${pageContext.request.contextPath }/static/img3/1496908784965972.jpg" alt="">
                                                                    <img class="img-2" src="${pageContext.request.contextPath }/static/img3/1496908791108442.jpg" alt="">
                                                                    <img class="img-3" src="${pageContext.request.contextPath }/static/img3/1496908793792265.jpg" alt="">
                                                                    <img class="img-4" src="${pageContext.request.contextPath }/static/img3/1496908796302649.jpg" alt="">
                                                                    <img class="img-5" src="${pageContext.request.contextPath }/static/img3/1497443896220.jpg" alt="">
                                                                    <img class="img-6" src="${pageContext.request.contextPath }/static/img3/1496908800673110.jpg" alt="">
                                                                    <img class="img-7" src="${pageContext.request.contextPath }/static/img3/1496908801973142.jpg" alt="">
                                    </div>
                <div class="pic-list rel  grou-2" style="display: none;">
                                                                    <img class="img-1" src="${pageContext.request.contextPath }/static/img3/1496910930516467.jpg" alt="">
                                                                    <img class="img-2" src="${pageContext.request.contextPath }/static/img3/1496910936459346.jpg" alt="">
                                                                    <img class="img-3" src="${pageContext.request.contextPath }/static/img3/1496910939493968.jpg" alt="">
                                                                    <img class="img-4" src="${pageContext.request.contextPath }/static/img3/1496910943475945.jpg" alt="">
                                                                    <img class="img-5" src="${pageContext.request.contextPath }/static/img3/1496910946401922.jpg" alt="">
                                                                    <img class="img-6" src="${pageContext.request.contextPath }/static/img3/1496910951851882.jpg" alt="">
                                                                    <img class="img-7" src="${pageContext.request.contextPath }/static/img3/1496910954972627.jpg" alt="">
                                    </div>
                <div class="change"> 换一组看看 <i class="corporate-culture-icon arrow"></i></div>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript" src="${pageContext.request.contextPath }/js/js3/jquery.movingboxes.js"></script>
<script type="text/javascript">
    //3D图片旋转  shareholder.jsp
    $('#lrtk').movingBoxes({
        startPanel: 6,
        reducedSize: .7,
        wrap: true,
...
<script type="text/javascript">
    ...
    //var showPicList=showPicList();
    function showPicList() {
        var ObjImg = $('.pic-list').find('i mg');//产品临时不要点击弹窗，所以破坏这里，后期要这个效果复位就好。
        var picLength = ObjImg.length;
        var next = $('.show-pic').find('.next');
        var pre = $('.show-pic').find('.pre');
        //显示图片
        ObjImg.click(function () {
            ...
            $('#vertical-center').css({
                'display': 'table'
            }).addClass('to-big').removeClass('to-hide');
            $('.show-pic').attr('src', mySrc);
            $('.layer').show();
            //下一张
            next.click(function () {
                _thisIndex++;
                if (_thisIndex == picLength) {
                    _thisIndex = 0
                }
                changePic();
            });
            ...
            pre.click(function () {
                _thisIndex--;
                if (_thisIndex == -1) {
                    _thisIndex = picLength - 1
                }
                changePic();
            });
            //切换图片
            function changePic() {
                mySrc = ObjImg.eq(_thisIndex).attr('src');
                $('.show-pic').attr('src', mySrc);
            }
            function close() {
                $('.dial-win').find('.close-x ').click(function () {
                    $(this).parents('#vertical-center').fadeOut(200).addClass('to-hide').removeClass('to-big');
                    $('.layer').fadeOut(200);
