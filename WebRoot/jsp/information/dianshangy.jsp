...
<div class="containder w1200 auto cl fix">
    <div class="position">您当前所在的位置：<a href="${pageContext.request.contextPath }/investmenthome.jsp">团贷网</a> &gt; <a href="${pageContext.request.contextPath }/consume">业务介绍</a> &gt;  电商供应链金融</div>
...
<div class="l left-side w218" id="left-side">
    ...
    <dl show="0">
        ...
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/dianshangy.jsp" target="_blank" class="left-selected">电商供应链金融</a></dd>
    ...
    <div class="r right-side w996">
        <div class="modular">
            <div class="banner"><img src="${pageContext.request.contextPath }/static/img3/banner3.jpg"></div>
            <div class="wrapbox mb0">
                <div class="f22 g3">简介</div>
                <div class="intr">
                    <p>电商供应链融资业务是团贷网联合深圳前海俊拓金融服务有限公司为淘宝网、唯品会、京东、amazon等平台商家提供的一种无抵押信用借款。受制于应收账款回款的及时性，电商企业流动性资金一般较为紧张，如遇重大促销活动可能出现无采购资金可用的现象，企业扩大经营备受制约。通过电商企业店铺账号授权，以及生意参谋等第三方工具协助，俊拓金融准确获取商家真实交易数据，严谨评估周期应收账款，并利用大数据风控模型对商家进行借款资质及金额审核。</p>
                </div>
            </div>
        </div>
        <div class="modular">
            ...
            <div class="wrapbox tc pb30 pt20">
                <img src="${pageContext.request.contextPath }/static/img3/info04.png">
            </div>
        </div>
        <div class="modular">
            <h2>风控<i class="shareholder-icon h2-arrow"></i></h2>
            <div class="wrapbox clearfix">
                                                                                    <div class="pointBox bt_ffbb26 ">
                            <span><img src="${pageContext.request.contextPath }/static/img3/1505283046154.png"></span>
                            <h5>小额分散</h5>
                            <p>人均借款金额约为3500元，同时借款人来自全国各地的各行各业，有效分散单一借款人带来的违约风险。</p>
                        </div>
                                                                    <div class="pointBox bt_ff6c43 ">
                            <span><img src="${pageContext.request.contextPath }/static/img3/1505283076813.png"></span>
                            <h5>真实消费</h5>
                            <p>借款人来源于真实消费场景，用途明确，还款来源可靠，违约成本高，贷后管理有据可查，方便追踪。</p>
                        </div>
                                                                    <div class="pointBox bt_31D893 mr0">
                            <span><img src="${pageContext.request.contextPath }/static/img3/1505283102111.png"></span>
                            <h5>风险可控</h5>
                            <p>多重风控手段，密切的跟踪管理，外加第三方合作机构担保垫付，将逾期违约风险降至最低。</p>
                        </div>
                                                </div>
        </div>
    </div>
...
<script>
    var shence_user_id = 'AbxExWdTpPyYC7dY8AWknLhbPfrDC2qHtf/ImmhZtPmTuXuVF883WA6fWWDLYcNCSI3JSLc11VVVVJz27Cb0fw==';
    (function(para) {
