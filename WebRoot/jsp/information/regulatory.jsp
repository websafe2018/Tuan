...
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>
    ...
    <div class="nav-w suspension   fixed z5 t0 l0 suspension" style="width:100%">
        <div class="nav-box auto w1200  fix">
            ...
            <div class="nav r">
                <ul>
                    ...
                    <li class="nav-t">
                        <a href="${pageContext.request.contextPath }/jsp/helppage/borrow money.jsp">我要借款</a>
                    </li>
                </ul>
            </div>
            <a style="float:left" class="logo-s dib" href="http://info.tuandai.com/"><img style="width:149px;position:relative;top:-5px;" alt="团贷网" src="${pageContext.request.contextPath }/static/img3/tuandai_logo_left.png"></a>
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/css3/regulatory.css">
<div class="containder w1200 auto cl fix">
    <div class="position">您当前所在的位置：<a href="${pageContext.request.contextPath }/investmenthome.jsp">团贷网</a> &gt; <a href="${pageContext.request.contextPath }/regulatory">法律法规</a> &gt;  监管部门</div>
...
<div class="l left-side w218" id="left-side">
    ...
    <dl show="0">
        ...
        <dd style="display: block;"><a href=" ${pageContext.request.contextPath }/jsp/information/regulatory.jsp" target="_blank" class="left-selected">监管部门</a></dd>
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/laws.jsp" target="_blank">法律法规</a></dd>
    </dl>
</div>

    <div class="r right-side w996">
        <div class="modular">
            <h2>监管部门<i class="shareholder-icon h2-arrow"></i></h2>
            <div class="regulatory">
                <p class="wz">
                    国务院：近期发布的《推进普惠金融发展规划（2016-2020年）》显示，国务院重视和关注互联网金融与风险防范。督促政府部门、部委等执行具体措施，通过国务院办公室新成立的金融事务局来指导和协调互联网金融发展相关工作。</p>
                <ul>
                                                <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801715776.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">中国人民银行</p>

                                    <p class="p2">中国人民银行（The People's Bank Of China），简称央行，是中华人民共和国的中央银行，中华人民共和国国务院组成部门。在国务院领导下，制定和执行货币政策，防范和化解金融风险，维护金融稳定。负责共享网络借贷信息中介机构有关统计数据，接收地方金融监管部门报送其辖区网络借贷信息中介机构重大风险及处置情况信息。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                                        <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801751473.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">中国互联网金融协会</p>

                                    <p class="p2">中国互联网金融协会（NATIONAL INTERNET FINANCE ASSOCIATION OF CHINA，英文缩写NIFA）是按照2015年7月18日经党中央、国务院同意，由人民银行、银监会、证监会、保监会、工信部、公安部、工商总局等10部委联合发布的《关于促进互联网金融健康发展的指导意见》（银发〔2015〕221号）要求，由中国人民银行会同银监会、证监会、保监会等国家有关部委组织建立的国家级互联网金融行业自律组织。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                                        <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801781825.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">中国银监会</p>

                                    <p class="p2">中国银行业监督管理委员会（简称：中国银监会或银监会；英文：China Banking Regulatory Commission ，英文缩写：CBRC）成立于2003年4月25日，是国务院直属正部级事业单位。根据国务院授权，统一监督管理银行、金融资产管理公司、信托投资公司及其他存款类金融机构，维护银行业的合法、稳健运行。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                                        <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801820767.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">公安部</p>

                                    <p class="p2">公安部是国务院主管全国公安工作的职能部门，牵头负责对网络亟待信息中介机构业务活动进行互联网安全监管，打击网络借贷涉及的金融犯罪工作。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                                        <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801857968.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">工信部</p>

                                    <p class="p2">中华人民共和国工业和信息化部（简称工信部）是国务院的直属部门，主要职责为拟订实施行业规划、产业政策和标准；监测工业行业日常运行；推动重大技术装备发展和自主创新；管理通信业；指导推进信息化建设；协调维护国家信息安全等，对互联网金融业务涉及的电信业务进行监管。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                                        <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801883803.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">国家工商总局</p>

                                    <p class="p2">中华人民共和国国家工商行政管理总局（简称国家工商总局）是中华人民共和国国务院主管市场监督管理和有关行政执法工作的正部级国务院直属机构，支持互联网企业依法办理工商注册登记。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                                        <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801914355.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">国家互联网信息办公室</p>

                                    <p class="p2">2011年5月，经国务院同意，设立国家互联网信息办公室。国家互联网信息办公室的主要职责包括：落实互联网信息传播方针政策和推动互联网信息传播法制建设，指导、协调、督促有关部门加强互联网信息内容管理，负责对金融信息服务、互联网信息内容等业务进行监管。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                                        <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801940368.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">广东互联网金融协会</p>

                                    <p class="p2">广东互联网金融协会是全国首家由政府批准成立的省级互联网金融行业社会组织。协会秉承推动广东互联网金融业创新发展、规范发展、健康发展，加快广东区域现代金融中心建设的成立目的，结合广东金融业发展特点，重点突出在建设健康安全的互联网金融等具有强烈现代信息特色的金融行业的服务。团贷网是广东互联网金融协会的副会长单位。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                                        <li>
                                <div class="tu"><img src="${pageContext.request.contextPath }/static/img3/1472801968701.jpg" alt=""></div>
                                <div class="describe">
                                    <p class="p1">东莞市人民政府金融工作局</p>

                                    <p class="p2">东莞市人民政府金融工作局是在原市金融服务办公室基础上成立的，新增了对小额贷款公司、融资性担保机构进行市场监管和风险处置，开展金融对外合作交流，指导协调金融改革创新综合试验区和金融商务区建设，培育和监管地方产权交易、柜台交易市场等相关职能。</p>
                                </div>
                            </li>
                            <div class="cl"></div>
                                        </ul></div>
