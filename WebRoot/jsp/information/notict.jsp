...
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>
    ...
    <div class="nav-w suspension   fixed z5 t0 l0 suspension" style="width:100%">
        ...
        <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/css/css3/notict.css">
<div class="containder w1200 auto cl fix">
    <div class="position">您当前所在的位置：<a href="${pageContext.request.contextPath }/investmenthome.jsp">团贷网</a> &gt; <a href="${pageContext.request.contextPath }/audit-report">对外公告</a> &gt;  团贷公告</div>
...
<div class="l left-side w218" id="left-side">
    ...
    <dl show="0">
        ...
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/auditreport.jsp" target="_blank">审计报告</a></dd>
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/bigissues.jsp" target="_blank">重大事项</a></dd>
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/notict.jsp" target="_blank" class="left-selected">团贷公告</a></dd>
    </dl>
    <dl show="0">
    ...
    <div class="r right-side w996">
        <div class="modular">
            <h2>团贷公告<i class="shareholder-icon h2-arrow"></i></h2>
            <div class="notict-list">
                <dl>
                    <dt> <span class="l pl20 b g3">公告标题</span> <span class="r b g3 pr15">发布日期</span></dt>
                                            <dd><span class="time r">2017-09-11</span>
                            <a href="#">关于厦门银行资金存管系统停服升级的公告  <i class="new notict-icon"></i>
                                                             </a>
                        </dd>
                                            <dd><span class="time r">2017-08-04</span>
                            <a href="#">团贷网系统升级公告  <i class="new notict-icon"></i>
                                                             </a>
                        </dd>
                                            <dd><span class="time r">2017-07-28</span>
                            <a href="#">关于提现手续费及提现优惠券调整的公告   <i class="new notict-icon"></i>
                                                             </a>
                        </dd>
                                            <dd><span class="time r">2017-07-24</span>
                            <a href="#">关于资产标区规则调整的公告 </a>
                        </dd>
                                            <dd><span class="time r">2017-07-13</span>
                            <a href="#">关于厦门银行存管系统紧急维护的通知  </a>
                        </dd>
                                            <dd><span class="time r">2017-07-05</span>
                            <a href="#">关于团贷网5周年活动的通知  </a>
                        </dd>
                                            <dd><span class="time r">2017-06-27</span>
                            <a href="#">团贷网系统升级公告 </a>
                        </dd>
                                            <dd><span class="time r">2017-06-21</span>
                            <a href="#">关于加息福利活动的通知 </a>
                        </dd>
                                            <dd><span class="time r">2017-06-08</span>
                            <a href="#">团贷网客服热线电话变更公告</a>
                        </dd>
                                            <dd><span class="time r">2017-05-27</span>
                            <a href="#">关于浦发银行系统紧急维护的通知  </a>
                        </dd>
                                            <dd><span class="time r">2017-05-25</span>
                            <a href="#">团贷网2017年端午节放假公告</a>
                        </dd>
                                            <dd><span class="time r">2017-05-03</span>
                            <a href="#">团贷网系统升级公告 </a>
                        </dd>
                                            <dd><span class="time r">2017-05-03</span>
                            <a href="#">团贷网业务调整公告 </a>
                        </dd>
                                            <dd><span class="time r">2017-04-27</span>
                            <a href="#">团贷网2017年劳动节放假公告</a>
                        </dd>
                                            <dd><span class="time r">2017-04-21</span>
                            <a href="#">关于建设银行系统紧急维护的通知</a>
                        </dd>
                                            <dd><span class="time r">2017-04-17</span>
                            <a href="#">关于团贷网投资产品收益率调整的指导公告  </a>
                        </dd>
                                            <dd><span class="time r">2017-03-31</span>
                            <a href="#">团贷网2017年清明节放假公告  </a>
                        </dd>
                                            <dd><span class="time r">2017-03-31</span>
                            <a href="#">关于厦门银行存管系统紧急维护的通知</a>
                        </dd>
                                            <dd><span class="time r">2017-03-15</span>
                            <a href="#">关于银行存管系统上线联调时间的说明</a>
                        </dd>
                                            <dd><span class="time r">2017-03-15</span>
                            <a href="#">关于厦门银行存管系统升级维护的通知</a>
                        </dd>
                                    </dl>
...
<div class="page">
        ...
        <!--当前页大于3，总页数大于7，就显示...-->
                        ...
                        <a href="${pageContext.request.contextPath }/notict?mark=9&amp;page=2" style="margin-right:5px;">2</a>
                        <a href="${pageContext.request.contextPath }/notict?mark=9&amp;page=3" style="margin-right:5px;">3</a>
                        <a href="${pageContext.request.contextPath }/notict?mark=9&amp;page=4" style="margin-right:5px;">4</a>
                        <a href="${pageContext.request.contextPath }/notict?mark=9&amp;page=5" style="margin-right:5px;">5</a>
                        <a href="${pageContext.request.contextPath }/notict?mark=9&amp;page=6" style="margin-right:5px;">6</a>
                <!--总页数 减去 当前页，大于4就显示...-->
            <span class="dian">...</span>
        <!--如果只有一页就不显示最后一页-->
                        <a href="${pageContext.request.contextPath }/notict?mark=9&amp;page=16" style="margin-right:5px;">16</a>
            
            <a class="next" href="${pageContext.request.contextPath }/notict?mark=9&amp;page=2">下一页</a>
        <span class="words">转到</span>
    <input type="text" class="pagenum" name="" id="pagenum" value=""><span class="words">页</span><a href="#" id="goto" data-url="${pageContext.request.contextPath }/notict?mark=9">确定</a>
</div>
<!-- <script>
    function goto(){
