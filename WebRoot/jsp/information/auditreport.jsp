...
<div class="containder w1200 auto cl fix">
    <div class="position">您当前所在的位置：<a href="${pageContext.request.contextPath }/investmenthome.jsp">团贷网</a> &gt; <a href="${pageContext.request.contextPath }/audit-report">对外公告</a> &gt;  审计报告</div>
...
<div class="l left-side w218" id="left-side">
    ...
    <dl show="0">
        ...
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/auditreport.jsp" target="_blank" class="left-selected">审计报告</a></dd>
    ...
    <div class="r right-side w996">
        <div class="modular">
            <div class="banner"><img src="${pageContext.request.contextPath }/static/img3/banner2.jpg"></div>
                                                                <div class="auditing mt30 mb30">
                        <i>2016年度报告</i>
                        <dl class="abstract"></dl>
                        <div class="pl33"><a target="_blank" href="#">查看详情 &gt;</a></div>
                    </div>
                                    </div>
    </div>
        ...
        <div class="fix">
            ...
            <div class="park-3 l">
                ...
                <div class="server-icon rel">
                    ...
                    <a class="online icon" href="3" target="_blank" title="在线服务" rel="nofollow"></a>
