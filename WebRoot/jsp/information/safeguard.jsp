...
<div class="containder w1200 auto cl fix">
    <div class="position">您当前所在的位置：<a href="${pageContext.request.contextPath }/investmenthome.jsp">团贷网</a> &gt; <a href="${pageContext.request.contextPath }/risk-controller">安全保障</a> &gt;  保障方式</div>
...
<div class="l left-side w218" id="left-side">
    ...
    <dl show="0">
        ...
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/safeguard.jsp" target="_blank" class="left-selected">保障方式</a></dd>
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/index4.jsp" target="_blank">担保专款</a></dd>
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/technologysafe.jsp" target="_blank">技术安全</a></dd>
    </dl>
    <dl show="0">
    ...
    <div class="r right-side w996">
        <div class="modular">
            <div class="banner"><img src="${pageContext.request.contextPath }/static/img3/banner5.jpg"></div>
        </div>
        <div class="modular">
            <h2>业务模式<i class="shareholder-icon h2-arrow"></i></h2>
            <div class="wrapbox pt20">
                <div class="tc pb30 mb35"><img src="${pageContext.request.contextPath }/static/img3/info07.png"></div>
                <div class="intr">
                    <p>当借款项目出现逾期时，若借款人没能在指定期限内按时还款，第三方担保公司会先行给投资用户垫付，具体为：普通会员垫付本金，超级会员垫付本息，其中资产标第31个逾期日垫付。</p>
                    <p>另外，第三方担保机构在厦门银行分别开设专有担保资金账户：“第三方担保专款”账户，当借款项目出现逾期时，担保公司自有资金先行垫付，若垫付资金不足则根据偿付规则启用“第三方担保专款资金”进行偿付，垫付投资者投资资金，以在一定限度内补偿出借人可能存在的回款损失。</p>
                </div>
            </div>
        </div>
    </div>
