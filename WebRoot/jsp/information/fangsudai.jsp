...
<div class="containder w1200 auto cl fix">
    <div class="position">您当前所在的位置：<a href="${pageContext.request.contextPath }/investmenthome.jsp">团贷网</a> &gt; <a href="${pageContext.request.contextPath }/consume">业务介绍</a> &gt;  房速贷</div>
...
<div class="l left-side w218" id="left-side">
  <dl show="0" >
    ...
    <dl show="0">
        ...
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/fangsudai.jsp" target="_blank" class="left-selected">房贷</a></dd>
    ...
    <div class="r right-side w996">
        <div class="modular">
            ...
            <div class="wrapbox mb0">
                ...
                <div class="intr">
                    <p>房速贷是借款人以个人持有的房产作为抵押物， 需要到房管局办理抵押手续并进行合同公证的个人信贷业务。</p>
                </div>
            </div>
        </div>
        <div class="modular">
