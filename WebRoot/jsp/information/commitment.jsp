...
<html lang="en-US"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><title>
    ...
    <div class="nav-w bgfff">
        <div class="nav-box auto w1200 fix">
            ...
            </div><a href="${pageContext.request.contextPath }/investmenthome.jsp" class="logo dib l">
...
<div class="containder w1200 auto cl fix">
    <div class="position">您当前所在的位置：<a href="${pageContext.request.contextPath }/investmenthome.jsp">团贷网</a> &gt; <a href="${pageContext.request.contextPath }/commitment">承诺书</a> &gt;  法人承诺书</div>
...
<div class="l left-side w218" id="left-side">
    ...
    <dl show="0">
        ...
        <dd style="display: block;"><a href="${pageContext.request.contextPath }/jsp/information/commitment.jsp" target="_blank" class="left-selected">法人承诺书</a></dd>
    </dl>
    <dl show="0">
    ...
    <div class="r right-side w996">
        <div class="modular">
            <div class="banner"><img src="${pageContext.request.contextPath }/static/img3/banner8.jpg"></div>
            <div class="wrapbox tc pb30 pt20">
                <img src="${pageContext.request.contextPath }/static/img3/info11.jpg">
            </div>
        </div>
    </div>
