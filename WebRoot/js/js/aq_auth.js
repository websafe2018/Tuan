(function(_w, _d) {
	...
	It.prototype.getSizeInfo = function($it) {
		...
		switch (sizeInfo) {
		case '124x47':
			info.w = 124;info.h = 47;info.sizeInfo = '124x47';
			break;case '83x30':
			info.w = 83;info.h = 30;info.sizeInfo = '83x30';
			break;case '70x70':
			info.w = 70;info.h = 70;info.sizeInfo = '70x70';
			break
		}
		;return info;
	};
	...
	It.prototype.getImgByInfo = function(sizeInfo, type) {
		...
		$img.setAttribute("src", '//static.anquan.org/static/outer/image/' + type + '_' + sizeInfo.sizeInfo + '.png' + '?id=' + _d.location.hostname + '?t=' + Math.floor(date / _d.location.hostname.length));$img.setAttribute("alt", '安全联盟认证');$img.setAttribute("width", sizeInfo.w);$img.setAttribute("height", sizeInfo.h);$img.setAttribute("style", "border: none;");return $img
	};
	It.prototype.getLinkByInfo = function(sizeInfo, typeInfo, $a) {
		...
		$a.setAttribute("href", url);$a.setAttribute("target", '_blank');$a.appendChild($img);return $a
	};
