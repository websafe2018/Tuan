...
var DQWebsiteUrl = "//dq.tdw.cn";

var portalWebsiteUrl_p2p = "//www.tdw.cn";
...
function login() {
    ...
    if (returnUrl == null || returnUrl == "") {
        ...
        if (returnUrl.toLowerCase().indexOf("/user/") > -1 || returnUrl.toLowerCase().indexOf("/user/ResetPwd_Telno.aspx") > -1) {
            return location.href = portalWebsiteUrl_p2p + "/user/login.aspx", !1
        }
    }

    return location.href = portalWebsiteUrl_p2p + "/user/login.aspx?ReturnUrl=" + returnUrl,
    !1
}
//跳到注册
function register() {
    ...
    if (returnUrl == null || returnUrl == "") {
        returnUrl = document.URL;
        if (returnUrl.toLowerCase().indexOf("/user/") > -1 || returnUrl.toLowerCase().indexOf("/user/ResetPwd_Telno.aspx") > -1 || returnUrl.toLowerCase().indexOf(portalWebsiteUrl_p2p) > -1) {
            return location.href = portalWebsiteUrl_p2p + "/user/register.aspx", !1
        }
    }

    return location.href = portalWebsiteUrl_p2p + "/user/register.aspx?ReturnUrl=" + returnUrl,
    !1
}
...
function logout() {
    ...
    if (returnUrl == null || returnUrl == "") {
        returnUrl = document.URL;
        if (returnUrl.toLowerCase().indexOf("/user/") > -1 || returnUrl.toLowerCase().indexOf("/user/ResetPwd_Telno.aspx") > -1) {
            return location.href = portalWebsiteUrl_p2p + "/user/logout.aspx", !1
        }
    }

    return location.href = portalWebsiteUrl_p2p + "/user/logout.aspx?ReturnUrl=" + returnUrl,
    !1
}
...
/*登录方法*/
function initLogin() {
    var url = portalWebsiteUrl_p2p + "/user/services/AccountHandler.ashx";
