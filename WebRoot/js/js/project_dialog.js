...
function LoginSubmit(ctrl, thirdParty) {
    ...
    pwd = fnStringJM(pwd);
    $(".login-btn").html("<img src='//js.tuandai.com/images/default/loading24.gif' alt='' style='position:relative;top:5px;' >&nbsp;正在登录中...");
    $.ajax({
        async: true,
        type: "post",
                ...
                if (document.URL.toLowerCase() == portalWebsiteUrl + "/default.aspx" || document.URL.toLowerCase() == portalWebsiteUrl + "/" ||
                    ...
                    $.ajax({
                        ...
                        success: function (json) {
                            ...
                            if (json.level == 2) {
                                $("#loginLevelImage").html("<img src=\"//js.tuandai.com/images/default/vip1.png\" alt=\"\" />");
                            } else {
                                $("#loginLevelImage").html("<img src=\"//js.tuandai.com/images/default/vip2.png\" alt=\"\" />");
                            }
        ...
        success: function (jsonstr) {
            ...
            if (jsonstr.result == "1") {
                ...
                if (jsonstr.list[0].IsScribeTanfer == "false") {
                    ...
                    {
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/mjnServiceContract.html' target='_blank'>《团贷网分期宝借款协议》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                        ...
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/niwojinrong_JiSuJie_ServiceContract.html' target='_blank'>《团贷网分期宝借款协议》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                    }
