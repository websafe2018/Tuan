	...
	try {
		...
		logger.info = function() {
			...
			return _.isObject(e) ? (_.each(e, function(t, r) {
				...
				_.isString(t) || _.isNumber(t) || _.isDate(t) || _.isBoolean(t) || _.isArray(t) || (logger.info("您的数据-", r, t, "-格式不满足要求，我们已经将其删除"),
				delete e[r]
				)
			}), e) : e
		...
		function e() {
			...
			this[r] = new this.stateInfo({
				...
				checkIsFirstLatest : function() {
					...
					e === t ? store.getProps() && "$latest_referrer" in store.getProps() || sd.register({
				...
				autoTrackSinglePage : function(e, t) {
					function r() {
						sd.track("$pageview", _.extend({
							$referrer : n,
							$referrer_host : _.url("hostname", n) || "",
							$url : location.href,
							$url_path : location.pathname,
							$title : document.title
						}, e), t), n = location.href
					}
					var n = _.info.pageProp.url;
					r(), this.autoTrackSinglePage = r
				},
