        ...
        $.ajax({
            ...
            success: function (json) {
                ...
                if (result == "1") {
                    ...
                    var $img = "<img src=\"//js2.tdw.cn/images/member/Bank/banklogo/banklogo_mini_" + json.model.bank_code + ".gif\">"
...
function redirectToDefault() {
    window.location.href = "/member/account_default.aspx";
}
