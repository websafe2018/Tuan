                   ...
                   s = 0;
                    for (var i = 0; i < incomedata.length; i++) {
                        if (incomedata[i].YearMonth == oldyear + "-" + (J >= 10 ? J : "0" + J)) {
                            ...
                            switch (index) {
                                case 0:
                                    p_data.push(parseFloat(Round2(parseFloat(incomedata[i].InterestAmout_1 + incomedata[i].InterestAmout_2 + incomedata[i].InterestAmout_3))));//+ incomedata[i].ReceiveValue
                                    break;
                                case 1:
