...
//    pwd = fnStringJM(pwd);
//    $(".login-btn").html("<img src='//js2.tdw.cn/images/default/loading24.gif' alt='' style='position:relative;top:5px;' >&nbsp;正在登录中...");
//    $.ajax({
//        async: true,
//        type: "post",
...
//                            if (json.level == 2) {
//                                $("#loginLevelImage").html("<img src=\"//js2.tdw.cn/images/default/vip1.png\" alt=\"\" />");
//                            } else {
//                                $("#loginLevelImage").html("<img src=\"//js2.tdw.cn/images/default/vip2.png\" alt=\"\" />");
//                            }
...
function shengou(id, tendValue, title) {
    showDialWindowsWithoutBtn("加载中", "<img src=\"//js2.tdw.cn/images/default/loading24.gif\" />&nbsp;正在加载页面，请稍候......");
            ...
            if (jsonstr.result == "1") {
                ...
                if (jsonstr.list[0].IsScribeTanfer == "false") {
                    if (type == 1 || type == 3 || type == 5) { //商友贷
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractType1.html' target='_blank'>《团贷网商友贷合同》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                        if (jiaxi != null) {
                            jiaxi.show();
                        }
                    } else if (type == 9 || type == 10 || type == 11 || type == 26) { //微团贷
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractType" + type + ".html' target='_blank'>《团贷网微团贷合同》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                        if (jiaxi != null) {
                            jiaxi.show();
                        }
                    } else if (type == 15 || type == 28) { //分期宝
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/fqbServiceContract.html' target='_blank'>《团贷网分期宝专区服务协议》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                    } else if (type == 24 || type == 25 || type == 27 ||type==29) {
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/phkxServiceContract.html' target='_blank'>《团贷网分期宝借款协议》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                    } else if (type == 6 || type == 7) { //资产标
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractType" + type + ".html' target='_blank'>《团贷网资产标借款合同》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                    } else if (type == 18) { //私募宝
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractType18_" + jsonstr.list[0].SmbProfitTypeId + ".html' target='_blank'>《团贷网私募宝合同》</a>  <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                        if (jiaxi != null && jsonstr.list[0].SMBType != "0") {
                            jiaxi.show();
                        }
                    } else if (type == 19 || type == 20) { //供应链
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractType" + type + ".html?deadtype=" + jsonstr.list[0].DeadType + "' target='_blank'>《团贷网供应链借款协议》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                    } else if (type == 21) { //活期宝
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a  class='font-orange' href='/member/contract/ContractType" + type + ".html' target='_blank'>《活期宝借贷合同》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                    } else if (type == 22 || type == 23) { //项目宝
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractType" + type + ".html' target='_blank'>《团贷网项目宝合同》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                        if (jiaxi != null && type == 22) {
                            jiaxi.show();
                        }
                    } else if (type == 40) { //一点车贷沿用车贷的合同
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractType40.html' target='_blank'>《团贷网微团贷借款合同》</a> <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                    } else if (type == 31) {
                        $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractType31.html' target='_blank'>《团贷网分期宝借款协议》</a>  <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                    }

                } else {
                    $("#art_PublicRate").hide();
                    $("#AgreeDiv").html("<label><input type='checkbox' id='ckbInvestAgree' checked='checked'/>我已阅读并同意</label><a class='font-orange' href='/member/contract/ContractZqzr.html' target='_blank'>《债权转让协议》</a>  <a class='font-orange' href='/member/contract/RiskWarningContract.html' target='_blank'>《风险揭示书》</a>");
                }
                $("#TranPwd").val("");
...
function investInitActive() {
    ...
    $('.join_action').click(function () {
        if (!isCookieLogin()) {
            ...
            showDialWindowsWithoutBtn(title, "<img src=\'//js2.tdw.cn/images/default/loading24.gif\' />&nbsp;正在加载页面，请稍候......");
...
function PostFinalDataNew(id, tendValue, nowUnit) {
    ...
    if (sign == 0)
        showDialWindowsWithoutBtn(newTitle, "<div style='color:gray;line-height:21px;'><img src=\"//js2.tdw.cn/images/default/loading24.gif\" />&nbsp;正在投标中，请稍后...</div>");
...
function AsyncGetBuyProjectStutasAgain(id, tendValue, nowUnit, jsonData) {
    ...
    if (checkCount < 3) {
        ...
        showDialWindowsWithoutBtn(newTitle, "<div style='color:gray;line-height:21px;'><img src=\"//js2.tdw.cn/images/default/loading24.gif\" />&nbsp;投标失败，请稍后再试...</div>");
    }
}
//显示购买计划
