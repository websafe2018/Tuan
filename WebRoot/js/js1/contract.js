...
function downloadPdf(type, contractNo, tranId) {
    if (isExitsFunction("showDialWindows")) {
        downloadPdfdialog = showDialWindows("团贷网提醒您", "<div style='padding:20px 10px;'><img src=\"//js.tuandai.com/images/default/loading24.gif\" />&nbsp;<span style='color:gray;font-size:13px;line-height:24px;'>正在生成合同，请稍候....</span></div>")
    } else {
        downloadPdfdialog = art.dialog({
            id: 'N1589' + Math.random(),
            width: 300,
            content: "<div style='padding:20px 10px;'><img src=\"//js.tuandai.com/images/default/loading24.gif\" />&nbsp;<span style='color:gray;font-size:13px;line-height:24px;'>正在生成合同，请稍候....</span></div>",
            fixed: false,
            lock: true,
            showborder: true,
            zIndex: 9999999,
